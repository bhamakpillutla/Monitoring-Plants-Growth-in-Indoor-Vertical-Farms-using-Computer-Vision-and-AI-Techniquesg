...
while ix < len(all_images):
   ...
   for im_path in images:
       ...
       cv2.imwrite('/home/psych256lab/Downloads/Scripts/test_results/test_sept20/'+str(d)+".jpg", out.get_image()[:,:,::-1])     
   ix = ix+6
   day = day + 1
dt = {'Date':csvDATE,'Day':csvDAY,'Time':csvTIME,'LeafIndex': csv_IDS,'Area':csvAREA,'Centroid':csvCENTROID}
df = pd.DataFrame(dt)
df.to_csv('/home/psych256lab/Downloads/Scripts/area_output(daytrack).csv')
...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  2 12:27:33 2021
...
while ix < len(all_images):
   ...
   for im_path in images:
       ...
       if(len(prevCentroidData) == 0) :    
            ...
            success = cv2.imwrite('/home/psych256lab/Downloads/Scripts/test_results/dummysample/'+str(d)+".jpg",out.get_image()[:,:,::-1])
           #print("output file written : ",success)
                ...
                for prev_centroid,prev_area,prev_poly,idx in zip(prevCentroidData,prevAreaData,prevPolys,prevValues):
                    ...
                    if (abs(distance) <= 50  ):
                        ...
                        if (shIntersection!= False ):
                            ...
                            #print(curr_centroid,shp(curr_poly).centroid,(shp(zeroecentered_curr_poly).centroid))
                            #print(prev_centroid,shp(prev_poly).centroid,(shp(zerocentered_prev_poly).centroid))
            ...
            cv2.imwrite('/home/psych256lab/Downloads/Scripts/test_results/dummysample/'+str(d)+"later.jpg", out.get_image()[:,:,::-1])
...
df = pd.DataFrame(dt)
df.to_csv('/home/psych256lab/Downloads/Scripts/area_output(dummy).csv')